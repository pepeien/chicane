...
namespace Chicane
{
    namespace Base64
    {
        ...
        decodeToUnsigned(const String& inEncoded);
        ...
        CHICANE_CORE std::vector<unsigned char>
        encodeToUnsigned(const String& inDecoded);
        CHICANE_CORE std::vector<char>
        encodeToSigned(const std::vector<char>& inDecoded);
