...
namespace Chicane
{
    ...
    public:
        ...
        static inline constexpr const Vec<4, float> Up =
            Vec<4, float>(Vec3::Up, 0.0f);
        static inline constexpr const Vec<4, float> Right =
            Vec<4, float>(Vec3::Right, 0.0f);
        static inline constexpr const Vec<4, float> Forward =
            Vec<4, float>(Vec3::Forward, 0.0f);
