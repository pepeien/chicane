...
namespace Chicane
{
    ...
    public:
        ...
        static inline constexpr const Vec<3, float> Up =
            Vec<3, float>(0.0f, 0.0f, 1.0f);
        static inline constexpr const Vec<3, float> Right =
            Vec<3, float>(1.0f, 0.0f, 0.0f);
        static inline constexpr const Vec<3, float> Forward =
