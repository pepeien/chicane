...
namespace Chicane
{
    namespace Screech
    {
        ...
        enum class SoundFlag : std::uint16_t
        {
            ...
            DefaultAttachment = 0x00001000,   /* Do not attach to the endpoint by default. Useful for when setting up nodes in a complex graph system. */
            NoPitch           = 0x00002000,   /* Disable pitch shifting with ma_sound_set_pitch() and ma_sound_group_set_pitch(). This is an optimization. */
