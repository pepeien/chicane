...
namespace Chicane
{
    namespace Grid
    {
        ...
        public:
            ...
            static inline constexpr const char* VIEWPORT_HEIGHT_SIZE_UNIT =
                "vh";
            ...
            // Display
            static inline constexpr const char* DISPLAY_ATTRIBUTE_NAME =
                "display";
            ...
            // Z-Index
            static inline constexpr const char* Z_INDEX_ATTRIBUTE_NAME =
                "z-index";

            // Flex
            static inline constexpr const char* FLEX_DIRECTION_ATTRIBUTE_NAME =
                "flex-direction";
            static inline constexpr const char* FLEX_DIRECTION_TYPE_ROW = "row";
            static inline constexpr const char* FLEX_DIRECTION_TYPE_COLUMN =
                "column";

            // Size
            static inline constexpr const char* WIDTH_ATTRIBUTE_NAME = "width";
            static inline constexpr const char* HEIGHT_ATTRIBUTE_NAME =
                "height";

            // Position
            static inline constexpr const char* POSITION_ATTRIBUTE_NAME =
                "position";
            static inline constexpr const char* POSITION_TYPE_ABSOLUTE =
                "absolute";
            static inline constexpr const char* POSITION_TYPE_RELATIVE =
                "relative";

            // Color
            static inline constexpr const char*
                BACKGROUND_COLOR_ATTRIBUTE_NAME = "background-color";
            static inline constexpr const char* BACKGROUND_COLOR_DEFAULT_COLOR =
                Color::HEX_COLOR_TRANSPARENT;

            static inline constexpr const char*
                FOREGROUND_COLOR_ATTRIBUTE_NAME = "color";
            static inline constexpr const char* FOREGROUND_COLOR_DEFAULT_COLOR =
            ...
            // Text
            static inline constexpr const char* FONT_FAMILY_ATTRIBUTE_NAME =
                "font-family";
            static inline constexpr const char* FONT_FAMILY_DEFAULT_VALUE =
                "Poppins";

            static inline constexpr const char* FONT_SIZE_ATTRIBUTE_NAME =
                "font-size";
            static inline constexpr const char* FONT_SIZE_DEFAULT_VALUE =
                "16px";

            static inline constexpr const char* LETTER_SPACING_ATTRIBUTE_NAME =
                "letter-spacing";
             ...
             * Template 4: "`TOP_MARGIN` `RIGHT_MARGIN` `BOTTOM_MARGIN`
             * `LEFT_MARGIN`"
             */
            static inline constexpr const char* MARGIN_ATTRIBUTE_NAME =
                "margin";
            static inline constexpr const char* MARGIN_TOP_ATTRIBUTE_NAME =
                "margin-top";
            static inline constexpr const char* MARGIN_BOTTOM_ATTRIBUTE_NAME =
                "margin-bottom";
            static inline constexpr const char* MARGIN_LEFT_ATTRIBUTE_NAME =
                "margin-left";
            static inline constexpr const char* MARGIN_RIGHT_ATTRIBUTE_NAME =
                "margin-right";
             ...
             * Template 4: "`TOP_PADDING` `RIGHT_PADDING` `BOTTOM_PADDING`
             * `LEFT_PADDING`"
             */
            static inline constexpr const char* PADDING_ATTRIBUTE_NAME =
                "padding";
            static inline constexpr const char* PADDING_TOP_ATTRIBUTE_NAME =
                "padding-top";
            static inline constexpr const char* PADDING_BOTTOM_ATTRIBUTE_NAME =
                "padding-bottom";
            static inline constexpr const char* PADDING_LEFT_ATTRIBUTE_NAME =
                "padding-left";
            static inline constexpr const char* PADDING_RIGHT_ATTRIBUTE_NAME =
                "padding-right";
            ...
            static inline constexpr const char* GAP_TOP_ATTRIBUTE_NAME =
                "gap-top";
            static inline constexpr const char* GAP_BOTTOM_ATTRIBUTE_NAME =
                "gap-bottom";
            static inline constexpr const char* GAP_LEFT_ATTRIBUTE_NAME =
                "gap-left";
            static inline constexpr const char* GAP_RIGHT_ATTRIBUTE_NAME =
                "gap-right";
        ...
        private:
            ...
            float
            parseSize(const String& inValue, StyleDirection inDirection) const;
            String parseText(const String& inValue) const;

            float parseCalculation(
            ...
            float parsePercentage(
                const String& inValue, StyleDirection inDirection
            ) const;
            float
            parsePercentage(float inValue, StyleDirection inDirection) const;
            ...
            float
            parseNumber(const String& inValue, const String& inUnit) const;
