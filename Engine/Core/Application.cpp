...
#define ENGINE_NAME "Chicane Engine"
...
namespace Engine
{
    namespace Core
    {
        ...
        bool Application::doesSupportExtensions(VkPhysicalDevice device)
        {
        ...
        bool Application::isSuitable(VkPhysicalDevice device)
        {
        ...
        void Application::initInstance()
        {
            ...
            app.pApplicationName = ENGINE_NAME;
        ...
        QueueFamilyIndices Application::getQueueFamily(VkPhysicalDevice device)
        {
        ...
        VkExtent2D Application::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
        {
            ...
            canonicalExtent.width = std::clamp(
                canonicalExtent.width,
                capabilities.minImageExtent.width,
                capabilities.maxImageExtent.width
            );
            canonicalExtent.height = std::clamp(
                canonicalExtent.height,
        ...
        VkShaderModule Application::initShaderModule(const std::vector<char>& code)
        {
        ...
        {
            VkShaderModule vertTriangleShaderModule = initShaderModule(FileSystem::readShader("triangle.vert.spv"));
            VkShaderModule fragTriangleShaderModule = initShaderModule(FileSystem::readShader("triangle.frag.spv"));
        ...
        void Application::writeCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
        {
