...
namespace Engine
{
	namespace Core
	{
		namespace Vulkan
		{
			...
			{
				void initSwapChain(
					Vulkan::SwapChain::Bundle& allocator,
				...
				{
					Vulkan::SwapChain::SupportDetails supportDetails;
					Vulkan::SwapChain::querySupport(supportDetails, inPhysicalDevice, inSurface);

					vk::SurfaceFormatKHR surfaceFormat;
					Vulkan::SwapChain::pickSurfaceFormat(surfaceFormat, supportDetails.formats);

					vk::PresentModeKHR presentMode;
					Vulkan::SwapChain::pickPresentMode(presentMode, supportDetails.presentModes);

					vk::Extent2D extent;
					Vulkan::SwapChain::pickExtent(extent, inWidth, inHeight, supportDetails.capabilities);
