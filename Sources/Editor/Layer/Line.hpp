...
namespace Editor
{
    ...
    {
    protected:
        Chicane::Vec4 getWireframeColor() const override { return ViewportOverlay::sInstance().geometryColor; }

        Chicane::Vec4 getOutlineColor() const override
        {
            return Chicane::Vec4(ViewportOverlay::sInstance().outlinerColor, 1.0f);
        }
    };
}
