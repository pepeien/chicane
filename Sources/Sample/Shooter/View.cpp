...
View::View()
    : Chicane::Grid::View("Contents/Sample/Shooter/Views/Home.grid"),
      ...
      m_uiFrameTime(
          Chicane::Reference::fromValue<const float>(&m_telemetry.delta)
      ),
      m_uiFramesPerSecond(
          Chicane::Reference::fromValue<const std::uint32_t>(&m_telemetry.rate)
      ),
      m_victoryVisibility(Chicane::Grid::Style::DISPLAY_TYPE_HIDDEN),
      m_uiVictoryVisibility(
          Chicane::Reference::fromValue<Chicane::String>(&m_victoryVisibility)
      ),
      m_currentCamera("None"),
      m_uiCurrentCamera(
          Chicane::Reference::fromValue<Chicane::String>(&m_currentCamera)
      ),
      m_crosshairDotVisibility(Chicane::Grid::Style::DISPLAY_TYPE_HIDDEN),
      m_uiCrosshairDotVisibility(
          Chicane::Reference::fromValue<Chicane::String>(
              &m_crosshairDotVisibility
          )
      ),
      ...
      m_uiCrosshairThickness(
          Chicane::Reference::fromValue<float>(&m_crosshairThickness)
      ),
      m_crosshairGap(0.05f),
      m_uiCrosshairGap(Chicane::Reference::fromValue<float>(&m_crosshairGap)),
      m_crosshairColorR(255),
      m_uiCrosshairColorR(
          Chicane::Reference::fromValue<std::uint8_t>(&m_crosshairColorR)
      ),
      m_crosshairColorG(255),
      m_uiCrosshairColorG(
          Chicane::Reference::fromValue<std::uint8_t>(&m_crosshairColorG)
      ),
      m_crosshairColorB(255),
      m_uiCrosshairColorB(
          Chicane::Reference::fromValue<std::uint8_t>(&m_crosshairColorB)
      ),
      m_crosshairColorA(255),
      m_uiCrosshairColorA(
          Chicane::Reference::fromValue<std::uint8_t>(&m_crosshairColorA)
      ),
      m_playerScore(0U),
      m_uiPlayerScore(
          Chicane::Reference::fromValue<std::uint32_t>(&m_playerScore)
      )
{
