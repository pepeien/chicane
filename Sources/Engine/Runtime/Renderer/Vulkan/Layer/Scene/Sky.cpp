...
namespace Chicane
{
    namespace Vulkan
    {
        ...
        void LSceneSky::initFrameResources()
        {
            ...
            Descriptor::initSetLayout(m_frameDescriptor.setLayout, m_internals.logicalDevice, frameLayoutBidings);
            ...
            Descriptor::initPool(m_frameDescriptor.pool, m_internals.logicalDevice, frameDescriptorPoolCreateInfo);
        ...
        void LSceneSky::initTextureResources()
        {
            ...
            Descriptor::initSetLayout(m_textureDescriptor.setLayout, m_internals.logicalDevice, materialLayoutBidings);

            Descriptor::PoolCreateInfo materialDescriptorPoolCreateInfo;
            materialDescriptorPoolCreateInfo.maxSets = 1;
            materialDescriptorPoolCreateInfo.sizes.push_back({vk::DescriptorType::eCombinedImageSampler, 1});

            Descriptor::initPool(m_textureDescriptor.pool, m_internals.logicalDevice, materialDescriptorPoolCreateInfo);
        }
        ...
        void LSceneSky::buildTextureData()
        {
            ...
            for (const auto& [side, texture] : m_asset->getSides())
            {
                ...
                createInfo.images.insert(std::make_pair(side, textureManager->getData(texture)));
            }
