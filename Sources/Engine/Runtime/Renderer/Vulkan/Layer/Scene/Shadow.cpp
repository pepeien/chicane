...
namespace Chicane
{
    namespace Vulkan
    {
        ...
        void LSceneShadow::initGraphicsPipeline()
        {
            ...
            vertexShader.path =
                "Contents/Engine/Shaders/Vulkan/Scene/Shadow.vert";
        ...
        void
        LSceneShadow::renderModels(const vk::CommandBuffer& inCommandBuffer)
        {
