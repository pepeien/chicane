        ...
        namespace GraphicsPipeline
        {
            ...
            )
            {
                ...
                createInfo.dynamicStateCount =
                    static_cast<std::uint32_t>(inDynamicStates.size());
            ...
            vk::PipelineColorBlendAttachmentState createBlendAttachmentState()
            {
                ...
                createInfo.dstColorBlendFactor =
            ...
            )
            {
                ...
                createInfo.setLayoutCount =
                    static_cast<std::uint32_t>(inDescriptorSetLayouts.size());
                createInfo.pSetLayouts = inDescriptorSetLayouts.data();
                createInfo.pushConstantRangeCount =
                    static_cast<std::uint32_t>(inPushConstants.size());
            ...
            )
            {
                ...
                createInfo.attachmentCount =
                    static_cast<std::uint32_t>(inAttachments.size());
                createInfo.pAttachments = inAttachments.data();
                createInfo.dependencyCount =
                    static_cast<std::uint32_t>(subpassDependecies.size());
