#include "Chicane/Runtime/Vulkan/Layer/Scene.hpp"
...
namespace Chicane
{
    namespace Vulkan
    {
        ...
        void LScene::destroyFrameResources()
        {
        ...
        void LScene::initGraphicsPipeline()
        {
            ...
            vertexShader.path = "Contents/Engine/Shaders/Vulkan/level.vert.spv";
            vertexShader.type = vk::ShaderStageFlagBits::eVertex;

            Shader::StageCreateInfo fragmentShader = {};
            fragmentShader.path = "Contents/Engine/Shaders/Vulkan/level.frag.spv";
        ...
        void LScene::destroyTextureResources()
        {
        ...
        void LScene::buildModelVertexBuffer()
        {
        ...
        void LScene::buildModelIndexBuffer()
        {
        ...
        void LScene::buildModelData()
        {
            buildModelVertexBuffer();
            buildModelIndexBuffer();
        }

        void LScene::destroyModelData()
        {
            m_internals.logicalDevice.waitIdle();
        ...
        void LScene::renderModels(const vk::CommandBuffer& inCommandBuffer)
        {
