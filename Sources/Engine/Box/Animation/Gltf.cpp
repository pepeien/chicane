...
namespace Chicane
{
    namespace Box
    {
        ...
        {
            static String animationName(const tg3_animation& inAnimation, std::uint32_t inIndex)
            {
            ...
            static AnimationClip parseAnimation(
                const Document& inDocument, const tg3_animation& inAnimation, const String& inId
            )
            {
