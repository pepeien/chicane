...
namespace Chicane
{
    namespace Box
    {
        namespace TextureGltf
        {
            namespace
            {
                ImageVendor vendorFromBytes(const unsigned char* inBytes, std::uint64_t inCount)
                {
                ...
                ImageVendor vendorFromImage(const tg3_image& inImage, const Image::Raw& inData)
                {
                ...
                String imageId(const tg3_image& inImage, std::uint32_t inIndex)
                {
                ...
                Image::Raw readBufferView(const tg3_model& inModel, std::int32_t inView)
                {
                ...
                Image::Raw readUri(const FileSystem::Path& inFilepath, const String& inUri)
                {
                    if (inUri.isEmpty())
                    {
                        return {};
                ...
                std::int32_t imageIndex(const tg3_model& inModel, std::int32_t inTextureIndex)
                {
