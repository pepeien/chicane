...
namespace Chicane
{
    namespace Renderer
    {
        namespace Shadow
        {
            ...
            static float length(const Vec3& inValue)
            {
            ...
            static void buildCascades(ShadowLight& outLight, const View& inCamera, const Vec3& inLightDirection)
            {
            ...
            static int findShadowCaster(const Light::List& inLights, std::uint32_t inCount)
            {
                int directional = -1;
                int any         = -1;
            ...
            static bool isVisible(const Light& inLight)
            {
                return inLight.intensity > 0.0f && inLight.color.dot(inLight.color) > 0.0f;
            }

            static std::uint32_t getPriority(const Light& inLight)
            {
                switch (inLight.type)
                {
            ...
            static Light::List selectLights(const View& inCamera, const Light::List& inLights)
            {
            ...
            static Vec4 getCone(const Light& inLight)
            {
