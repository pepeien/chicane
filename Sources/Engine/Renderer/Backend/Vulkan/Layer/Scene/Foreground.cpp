...
namespace Chicane
{
    namespace Renderer
    {
        ...
        void VulkanLSceneForeground::onRestart()
        {
            initFramebuffers();
        }

        void VulkanLSceneForeground::onDestruction()
        {
        ...
        bool VulkanLSceneForeground::onBeginRender(const Frame& inFrame)
        {
            return inFrame.hasForegroundDraws();
        }

        void VulkanLSceneForeground::onRender(const Frame& inFrame, void* inData)
        {
        ...
        void VulkanLSceneForeground::initFrameResources()
        {
            VulkanBackend* backend = getBackend<VulkanBackend>();
            VulkanLScene*  parent  = backend->getLayer<VulkanLScene>(SCENE_LAYER_ID);
        ...
        void VulkanLSceneForeground::updateSkyDescriptors(const vk::DescriptorImageInfo& inInfo)
        {
            VulkanBackend* backend = getBackend<VulkanBackend>();
            VulkanLScene*  parent  = backend->getLayer<VulkanLScene>(SCENE_LAYER_ID);
        ...
        void VulkanLSceneForeground::destroyFrameResources()
        {
            VulkanBackend* backend = getBackend<VulkanBackend>();
        ...
        void VulkanLSceneForeground::initGraphicsPipeline()
        {
            VulkanBackend* backend = getBackend<VulkanBackend>();
        ...
        void VulkanLSceneForeground::initFramebuffers()
        {
            VulkanBackend* backend  = getBackend<VulkanBackend>();
            vk::Viewport   viewport = backend->getVkViewport(this);
