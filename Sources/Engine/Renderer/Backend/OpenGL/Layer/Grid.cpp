...
namespace Chicane
{
    namespace Renderer
    {
        ...
        void OpenGLLGrid::buildPrimitiveVertexBuffer()
        {
            ...
            glNamedBufferData(
                m_primitiveVertexBuffer,
                m_backend->getResourceBudget(BackendResource::UIVertices),
                nullptr,
                GL_DYNAMIC_DRAW
            );
        ...
        void OpenGLLGrid::buildPrimitiveIndexBuffer()
        {
            ...
            glNamedBufferData(
                m_primitiveIndexBuffer,
                m_backend->getResourceBudget(BackendResource::UIIndices),
                nullptr,
                GL_DYNAMIC_DRAW
            );
        }
        ...
        void OpenGLLGrid::buildInstanceData()
        {
            ...
            glNamedBufferData(
                m_instanceBuffer,
                m_backend->getResourceBudget(BackendResource::UIInstances),
                nullptr,
                GL_DYNAMIC_DRAW
            );
