...
namespace Chicane
{
    namespace Base64
    {
        ...
        {
            return base64::encode_into<std::vector<unsigned char>>(inDecoded.begin(), inDecoded.end());
        }

        std::vector<unsigned char> encodeToUnsigned(const String& inDecoded)
        {
            return base64::encode_into<std::vector<unsigned char>>(inDecoded.toStandard());
        }

        std::vector<char> encodeToSigned(const std::vector<char>& inDecoded)
        {
            return base64::encode_into<std::vector<char>>(inDecoded.begin(), inDecoded.end());
        }

        std::vector<char> encodeToSigned(const String& inDecoded)
        {
            return base64::encode_into<std::vector<char>>(inDecoded.toStandard());
        }

        String encode(const std::vector<unsigned char>& inDecoded)
        {
            return base64::encode_into<std::string>(inDecoded.begin(), inDecoded.end());
        }
        ...
        {
            return base64::encode_into<std::string>(inDecoded.toStandard());
        }
    }
}