...
namespace Reflector
{
    static class Emitter
    {
        public static string Emit(
            ...
            IReadOnlySet<string> reflectedTypeNames,
            string? baseDir = null
        )
        {
            ...
            {
                EmitType(sb, t, reflectedTypeNames);
            }
        ...
        static void EmitType(StringBuilder sb, TypeModel t, IReadOnlySet<string> reflectedTypeNames)
        {
            ...
            foreach (FieldModel f in t.Fields)
            {
                ...
                bool isReflected = reflectedTypeNames.Contains(f.TypeName);
