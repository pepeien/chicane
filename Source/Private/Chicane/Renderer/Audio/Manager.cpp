...
namespace Chicane
{
    namespace Audio
    {
        static const Audio::Instance EMPTY_INSTANCE = {};
        static const Audio::Data     EMPTY_DATA     = {};
        ...
        void Manager::onActivation(const std::string& inId)
        {
            ...
            Audio::Instance instance = getInstance(inId);
        ...
        {
            Audio::Data& audio = m_datum.at(inId);
        ...
        void Manager::load(const std::string& inId, const Box::Audio* inAsset)
        {
            if (isLoaded(inId))
            {
                return;
        ...
        const Audio::Instance& Manager::getInstance(const std::string& inId) const
        {
            if (!isLoaded(inId))
            {
        ...
        const Audio::Data& Manager::getData(const std::string& inId) const
        {
