    ...
    namespace Vulkan
    {
        namespace Model
        {
            ...
            void Manager::load(const std::string& inId, const Box::Model* inAsset)
            {
                ...
                Chicane::Model::Parse::Result result {};

                switch (inAsset->getVendor())
                {
                case Chicane::Model::Vendor::Type::Wavefront:
                    Chicane::Model::Vendor::Wavefront::parse(result, inAsset->getData());
                ...
                Chicane::Model::Instance newModel {};
            ...
            )
            {
                ...
                const Chicane::Model::AllocationInfo& allocationInfo = m_allocationMap.at(inId);
            ...
            void Manager::allocate(const std::string& inId)
            {
                ...
                const Chicane::Model::Instance& instance = m_instanceMap.at(inId);

                Chicane::Model::AllocationInfo allocationInfo {};
            ...
            void Manager::deallocate(const std::string& inId)
            {
                ...
                const Chicane::Model::AllocationInfo& instance = m_allocationMap.at(inId);
